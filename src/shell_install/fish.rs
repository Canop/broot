...
//! needed. Unfortunately, it doesn't work well with symlinked directories,
//! so for now we store the function directly in that directory, rather
//! than linking to BROOT_DIR/launcher/fish.

use std::path::PathBuf;

use directories::{BaseDirs, ProjectDirs};

use super::ShellInstall;
...
function br
    ...
    if not broot --outcmd $cmd_file $argv
        set -l code $status
        rm -f $cmd_file
        return $code
    else
