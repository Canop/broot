        ...
        Ok(match internal_exec.internal {
            ...
            Internal::purge_trash => {
                let res = trash::os_limited::list()
                    .and_then(|items| trash::os_limited::purge_all(items));
                match res {
            ...
            Internal::help => {
                ...
                if bang && cc.app.preview_panel.is_none() {
                    ...
                    CmdResult::new_state(Box::new(HelpState::new(
                        self.tree_options(),
                        screen,
                        con,
                    )))
            ...
            Internal::toggle_git_ignore | Internal::toggle_ignore => self
                .with_new_options(
                    screen,
                    &|o| {
            ...
            Internal::refresh => CmdResult::RefreshState {
                clear_cache: true,
            },
            Internal::quit => CmdResult::Quit,
            Internal::clear_output => verb_clear_output(con)
