...
Internals! {
    ...
    clear_favorites: "empty the favorites list" false,
    clear_stage: "empty the staging area" false,
    close_favorite_area: "close the favorites panel" false,
    ...
    favorite: "add selection to favorites" true,
    ...
    open_favorite_area: "open the favorites panel" false,
    ...
    toggle_favorite: "add or remove selection from favorites" true,
    toggle_favorite_area: "open/close the favorites panel" false,
    ...
    unfavorite: "remove selection from favorites" true,
