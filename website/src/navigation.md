...
* <kbd>ctrl</kbd><kbd class=b>←</kbd> or <kbd>ctrl</kbd><kbd class=b>→</kbd> (<kbd>alt</kbd><kbd class=b>←</kbd> and <kbd>alt</kbd><kbd class=b>→</kbd> [on macOS](../common-problems/#ctrl-arrows-or-alt-arrows)) : focus (or open) a panel to the left or to the right
